...
public class ManagePortfolio {
   ...
   public static void main(String[] args) {
      ...
      ManagePortfolio ME = new ManagePortfolio();
  ...
  //  ME.deleteEmployee(empID2);
   ...
   public String addEmployee(String fname){
      ...
      try{ 
         ...
         Portfolio employee = new Portfolio(fname);
   ...
   public void listEmployees( ){
      ...
      try{
         tx = session.beginTransaction();
         List employees = session.createQuery("FROM Portfolio").list(); 
         for (Iterator iterator = 
                           employees.iterator(); iterator.hasNext();){
        	 Portfolio employee = (Portfolio) iterator.next(); 
